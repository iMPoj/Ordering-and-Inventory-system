<div id="adminPage" class="hidden">
    ...
    <div id="adminBulkOrderSection" class="hidden">
        <div class="content-card max-w-4xl mx-auto">
            ...
            <p class="text-sm text-slate-500 mb-6">Copy the entire text from a supplier PDF, paste it into the box below, and click parse to create a new order for review.</p>
            <div class="space-y-4">
                <div>
